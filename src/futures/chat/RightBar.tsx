...
export default function RightBar({ isOpen, onClose, contactInfo }: RightBarProps) {
  return (
    <div
      className={`fixed right-0 top-0 h-full w-80 bg-white border-l transform transition-transform duration-300 ease-in-out ${
    ...
    >
      ...
      <div className="p-4 border-b">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            <div className="font-medium">{contactInfo?.name || 'Unknown'}</div>
